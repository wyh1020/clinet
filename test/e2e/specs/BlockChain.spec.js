...
describe('BlockChain', function () {
  ...
  it('BlockChain-测试1', function () {
    ...
    // 2.3、点击区块查询
      ...
      // 2.3.2、点击前一页(block-up)
      .click('#block-up')
      .waitUntilTextExists('#notice-bar', '已经是第一页')
      // 2.3.3、点击后一页(block-down)
      .click('#block-down')
      .waitUntilTextExists('#notice-bar', '已经是最后一页')
      // 2.3.4、点击区块内容(block-content)
      .click('#block-content')
      .waitUntilTextExists('#notice-bar', '区块内容')
      // 2.3.5、点击区块内容明细(block-info)
      .click('#block-info')
