...
describe('BlockChain', function () {
  ...
  it('BlockChain-测试1', function () {
    ...
    // 2.1、点击服务器节点设置
      ...
      .getText('.block-rightpanel-server')
      ...
      .waitUntilTextExists('#notice-bar', '区块链服务功能列表')
    // 2.2、点击账户设置
      .click('#navbar-block')
