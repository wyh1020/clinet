...
describe('Edit', function () {
  ...
  it('Edit-测试1', function () {
    ...
    // 2.2.1 点击下拉菜单 病案首页(卫统四csv)按钮
    // 2.2.1.1 点击下拉菜单入院申请按钮
    // 2.2.1.1.1 点击下拉菜单 首次病程按钮
    // 2.2.1.1.1.1 点击下拉菜单 病程记录按钮
    // 2.2.1.1.1.1.1 点击下拉菜单 病案首页按钮
    // 2.2.1.1.1.1.1.1 点击下拉菜单 门诊病案按钮
    // 2.2.1.1.1.1.1.1.1 点击下拉菜单 健康体检按钮
    ...
    // 2.10.1.6.1 点击下拉菜单 病案首页(卫统四csv)按钮
    // 2.10.1.6.1.1 点击下拉菜单入院申请按钮
    // 2.10.1.6.1.1.1 点击下拉菜单 首次病程按钮
    // 2.10.1.6.1.1.1.1 点击下拉菜单 病程记录按钮
    // 2.10.1.6.1.1.1.1.1 点击下拉菜单 病案首页按钮
    // 2.10.1.6.1.1.1.1.1.1 点击下拉菜单 门诊病案按钮
    // 2.10.1.6.1.1.1.1.1.1.1 点击下拉菜单 健康体检按钮
    ...
    // 2.10.2.1.6.1 点击下拉菜单 病案首页(卫统四csv)按钮
    // 2.10.2.1.6.1.1 点击下拉菜单入院申请按钮
    // 2.10.2.1.6.1.1.1 点击下拉菜单 首次病程按钮
    // 2.10.2.1.6.1.1.1.1 点击下拉菜单 病程记录按钮
    // 2.10.2.1.6.1.1.1.1.1 点击下拉菜单 病案首页按钮
    // 2.10.2.1.6.1.1.1.1.1.1 点击下拉菜单 门诊病案按钮
    // 2.10.2.1.6.1.1.1.1.1.1.1 点击下拉菜单 健康体检按钮
    ...
    // 2.10.2.2.6.1 点击下拉菜单 病案首页(卫统四csv)按钮
    // 2.10.2.2.6.1.1 点击下拉菜单入院申请按钮
    // 2.10.2.2.6.1.1.1 点击下拉菜单 首次病程按钮
    // 2.10.2.2.6.1.1.1.1 点击下拉菜单 病程记录按钮
    // 2.10.2.2.6.1.1.1.1.1 点击下拉菜单 病案首页按钮
    // 2.10.2.2.6.1.1.1.1.1.1 点击下拉菜单 门诊病案按钮
    // 2.10.2.2.6.1.1.1.1.1.1.1 点击下拉菜单 健康体检按钮
