<template>
  <div>
    ...
    <share-bar v-if="toolbar == '区块链服务-共享查询'"></share-bar>
    ...
    <right-panel-share v-if="toolbar == '区块链服务-共享查询'"></right-panel-share>
...
<script>
  ...
  import RightPanelShare from './RightPanelShare';

  export default {
    components: { DrgBar, ServerBar, UserBar, StatBar, BlockBar, RightPanelUser, RightPanelBlock, RightPanelServer, RightPanelDrg, RightPanelStat, RightPanelShare, ShareBar },
    computed: {
      toolbar: {
        get() {
